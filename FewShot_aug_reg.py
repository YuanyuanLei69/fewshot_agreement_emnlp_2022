    ...
    for i in range(len(tasks)):
        ...
        if i % (10 * num_epochs) == 0 and not i == 0:
            ...
            if macro_F > best_macro_F:
                torch.save(fewshot_model.state_dict(), './saved_models/fewshot_model_divide_domain_add_loss_best.ckpt')
...
fewshot_model.load_state_dict(torch.load("./saved_models/fewshot_model_divide_domain_add_loss_best.ckpt", map_location=device))
